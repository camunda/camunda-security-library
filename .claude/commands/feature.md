---
name: feature
description: Use when the user requests a new capability, says "we should be able to", "add support for", "I want to be able to", or describes functionality that doesn't exist yet
---

# Track Feature

Create a GitHub issue from a short feature description that is **self-contained enough for a fresh agent session to pick up and deliver a complete implementation without further conversation**.
