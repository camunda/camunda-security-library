...
These constraints directly inform the choice and implementation details in the proposed, not-yet-implemented [Push vs Pull Policy Propagation](../vision/push-vs-pull-policy-propagation.md) vision document; see section 9.2 for detailed analysis.
