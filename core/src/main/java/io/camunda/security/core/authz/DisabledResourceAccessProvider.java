...
/**
 * {@link ResourceAccessProvider} used when authorization checks are disabled: every principal holds
 * a wildcard grant covering all resources, regardless of authentication.
 */
public final class DisabledResourceAccessProvider implements ResourceAccessProvider {
