...
See [`docs/adopters/security-filter-chains.md`](docs/adopters/security-filter-chains.md) for the full configuration reference, extension hooks, and migration guide. Design rationale lives in [ADR-0003](docs/adr/0003-no-spring-boot-auto-configuration.md).
