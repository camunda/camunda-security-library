 ...
 * even when the bean is present (see ADR-0004 and GH-189). Hosts that need the check on a custom
...
class AdminUserCheckFilterChainIntegrationTest {
  ...
  void oidcChainOmitsAdminUserCheckFilterEvenWhenBeanIsPresent() {
    // GH-189 / ADR-0004: the OIDC chain configuration does not add the admin-user check filter,
