...
/**
 * Decides what to do when the {@code WebAppAuthorizationCheckFilter} denies access to a web app.
 * Hosts implement this SPI to return a 403 JSON body, redirect to a URL, or apply any other
