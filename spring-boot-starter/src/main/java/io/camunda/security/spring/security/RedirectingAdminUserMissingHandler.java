...
/**
 * Default {@link AdminUserMissingHandlerPort} reference implementation. Redirects the browser to
 * {@code <contextPath>/admin/setup} so the host's setup UI can render (preserves the legacy OC
 * behaviour).
 *
