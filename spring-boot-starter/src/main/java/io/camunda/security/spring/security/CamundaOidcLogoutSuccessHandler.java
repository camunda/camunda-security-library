 ...
 *       multi-provider deployment can carry its own landing URL or send none at all (ADR-0026).
 * </ul>
 *
 ...
 * point off-host, which is the point of ADR-0026: an account page on another host is often the only
...
public final class CamundaOidcLogoutSuccessHandler extends OidcClientInitiatedLogoutSuccessHandler {
   ...
   * the behaviour this class had before ADR-0026.
   */
