 ...
 * see ADR-0003 for why CSL configurations are explicitly imported rather than auto-registered.
 *
 ...
 * — the same unified inbound port the data plane uses (see ADR-0014). The check honours {@code
