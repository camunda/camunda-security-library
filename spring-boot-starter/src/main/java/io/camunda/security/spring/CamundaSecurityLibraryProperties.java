...
public class CamundaSecurityLibraryProperties {
   ...
   * camunda.security.session.heartbeat.enabled=true} (ADR-0023). CSL has no visibility into the
   ...
   * shorter than {@link #MIN_RECOMMENDED_HEARTBEAT_INTERVAL}. See ADR-0023.
   */
