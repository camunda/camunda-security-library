...
public class WebSessionConfiguration {
   ...
   * to its scope (ADR-0029). The {@link ScopedSessionStorePortProvider} is optional — when a host
   ...
   * per-scope one (ADR-0029). Resolved per sweep so scoped repositories created after startup are
   * included.
   */
