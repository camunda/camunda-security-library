 ...
 * chains (ADR-0017). Always active: the primary chains always need a session filter, exactly as
...
public class DefaultWebSessionFilterConfiguration {
   ...
   * reintroducing exactly the nested-filter, shared-request-attribute interference ADR-0017
