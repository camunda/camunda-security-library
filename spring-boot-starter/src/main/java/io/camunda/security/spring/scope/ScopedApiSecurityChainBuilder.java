...
public final class ScopedApiSecurityChainBuilder {
   ...
   *
   * <p>See ADR-0034 for why this is a per-invocation parameter rather than a globally-registered
   ...
   * {@code oidcDecoderSupplier}, whose result must never be {@code null}. See ADR-0034.
   */
  public SecurityFilterChain buildScopedApiChain(
      final HttpSecurity http,
      final String basePath,
