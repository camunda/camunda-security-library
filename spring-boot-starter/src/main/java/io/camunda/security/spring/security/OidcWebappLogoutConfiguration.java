 ...
 * on the session under {@link CamundaWebappAttributes#POST_LOGOUT_REDIRECT_ATTRIBUTE}, and the OIDC
 * {@code login_hint} claim is forwarded as {@code logout_hint} to the IdP's end-session endpoint.
 *
